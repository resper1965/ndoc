 ...
 * 
 * n.doc - Aplicação de documentação
 * Produtor: ness.
 * 
...
export const clientBranding: ClientBranding = {
  ...
  name: "n.doc", // Nome padrão, pode ser alterado pelo cliente
 ...
 * Se o cliente configurou um nome, usa o do cliente, senão usa "n.doc"
 */
